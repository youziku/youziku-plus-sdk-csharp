...
{
    public  class TestRamUnicodeScopeWebFontImpl : BaseTestImpl, IInterfaceTestAsync
    {
        public async Task<object >Run()
        {
            ...
            var woffResponeAsync = await YouzikuPlusClient.GetScopeWoffFontFaceAsync(new RamUnicodeScopeFontApiParam()
            {
                AccessKey = "xxx",
                UseRanFontFamily = true,
                Content =
